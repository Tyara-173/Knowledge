...
![alt text](../imgs/mod-beginning/ftbUlt.png)
...
![alt text](../imgs/mod-beginning/backpack.png)

### JEI（Just Enough Items）
- とても便利なレシピmod　特に設定の変更はいらないです
- インベントリ等の中のアイテムにカーソルを合わせて「U」または「R」でレシピ検索に飛べる

![alt text](../imgs/mod-beginning/JEI1.png)

- レシピ検索内のアイテムを左クリック/右クリックでさらに飛べる

![alt text](../imgs/mod-beginning/JEI2.png)

- インベントリ右にある検索バーで任意のアイテムのレシピを検索することもできる

![alt text](../imgs/mod-beginning/JEI3.png)

- 作業台等を開いてるとき，対象のレシピが作成可能なら「+」のボタンを押すことで配置・作成できる

![alt text](../imgs/mod-beginning/JEI4.png)

![alt text](../imgs/mod-beginning/JEI5.png)
